...
as ~4 MeV $<<$ $2m_V$, from Eq.~\ref{eq:width}.
...
energy scale of the form factor, with the scan shown in Fig.~\ref{fig:structureScan}
...
\begin{figure}[!ht]
\includegraphics[width=\linewidth]{images/Paper_Structure.pdf}
